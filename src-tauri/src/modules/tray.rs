...
use tauri::{
    menu::{Menu, MenuItem},
    tray::{TrayIcon, MouseButton, MouseButtonState, TrayIconBuilder, TrayIconEvent}, Manager, PhysicalPosition, Position, WebviewWindow,
};

/// 托盘状态包装，供 update_tray_tooltip 命令使用
pub struct TrayStateInner(pub Mutex<TrayIcon>);
...
pub fn setup_tray(app: &tauri::App) -> Result<(), Box<dyn std::error::Error>> {
    ...
    app.manage(TrayStateInner(Mutex::new(tray)));
    Ok(())
}
